...
4.10.1 - Released on 15 February 2024
...
4.10.0 - Released on 08 February 2024
...
4.9.0 - Released on 30 January 2024
...
4.8.1 - Released on 26 January 2024
...
4.8.0 - Released on 16 January 2024
...
4.7.0 - Released on 21 December 2023
...
4.6.1 - Released on 28 November 2023

* Tweak: hide add to cart button when the addons type label are required
* Fix: product price replacement
* Fix: show add-on price excluding vat
* Fix: required upload add-ons
* Dev: new filter 'yith_wapo_number_main_css_class'
...
4.5.0 - Released on 03 October 2023
