		...
		<div id="addon-editor" class="yith-wapo-addon-type-<?php echo esc_html( $addon_type ); ?>" data-addon-type="<?php echo esc_html( $addon_type ); ?>">
			...
			<?php if ( '' !== $addon_type ) :
				...
				<form action="admin.php?page=yith_wapo_panel&tab=blocks" method="post" id="addon">
                    ...
                    <input type="hidden" name="block_rule_show_in_products" value="<?php echo ! empty( $block->get_rule( 'show_in_products', '' ) ) ? esc_attr( json_encode( $block->get_rule( 'show_in_products' ) ) ) : ( isset( $_REQUEST['block_rule_show_in_products'] ) ? esc_attr( json_encode( $_REQUEST['block_rule_show_in_products'] ) ) : '' ); ?>">
                    <input type="hidden" name="block_rule_show_in_categories" value="<?php echo ! empty( $block->get_rule( 'show_in_categories', '' ) ) ? esc_attr( json_encode( $block->get_rule( 'show_in_categories' ) ) ) : ( isset( $_REQUEST['block_rule_show_in_categories'] ) ? esc_attr( json_encode( $_REQUEST['block_rule_show_in_categories'] ) ) : '' ); ?>">
                    ...
                    <input type="hidden" name="block_rule_exclude_products_products" value="<?php echo ! empty( $block->get_rule( 'exclude_products_products', '' ) ) ? esc_attr( json_encode( $block->get_rule( 'exclude_products_products' ) ) ) : ( isset( $_REQUEST['block_rule_exclude_products_products'] ) ? esc_attr( json_encode( $_REQUEST['block_rule_exclude_products_products'] ) ) : '' ); ?>">
                    <input type="hidden" name="block_rule_exclude_products_categories" value="<?php echo ! empty( $block->get_rule( 'exclude_products_categories', '' ) ) ? esc_attr( json_encode( $block->get_rule( 'exclude_products_categories' ) ) ) : ( isset( $_REQUEST['block_rule_exclude_products_categories'] ) ? esc_attr( json_encode( $_REQUEST['block_rule_exclude_products_categories'] ) ) : '' ); ?>">
                    ...
                    <input type="hidden" name="block_rule_show_to_user_roles" value="<?php echo ! empty( $block->get_rule( 'show_to_user_roles', '' ) ) ? esc_attr( json_encode( $block->get_rule( 'show_to_user_roles' ) ) ) : ( isset( $_REQUEST['block_rule_show_to_user_roles'] ) ? esc_attr( json_encode( $_REQUEST['block_rule_show_to_user_roles'] ) ) : '' ); ?>">
