...
if (yith_wapo_is_addon_type_available($addon_type) && (file_exists($template_file) || 'new' === $addon_id)) : ?>
    ...
    <div id="yith-wapo-addon-overlay" class="yith-plugin-fw yith-plugin-ui yith-wapo">
        <div id="addon-editor" class="yith-wapo-addon-type-<?php echo esc_html($addon_type); ?>"
             data-addon-type="<?php echo esc_html($addon_type); ?>">
            ...
            <?php if ('' !== $addon_type) :
                ...
                <form action="admin.php?page=yith_wapo_panel&tab=blocks" method="post" id="addon">
                    ...
                    <?php if ('new' === $addon_id) : ?>
                        <a href="admin.php?page=yith_wapo_panel&tab=blocks&block_id=<?php echo esc_attr($block_id); ?>&addon_id=new"
                        ...
                        <div id="addon-container">
                            ...
                            <div id="tab-options-list">
                                ...
                                if ('html_heading' === $addon_type || 'html_separator' === $addon_type || 'html_text' === $addon_type) :
                                    ...
                                    <div class="field-wrap addon-field-grid" style="margin-top: 20px;">
                                        ...
                                        <div class="field">
                                            <div class="addon-title-container">
                                                <input type="text" name="addon_title" id="addon-title"
                                                       value="<?php echo esc_attr($addon->get_setting('title', '', false)); ?>">
                                    ...
                                    <!-- End option field -->
                                    <div class="field-wrap addon-title-in-cart-opt-container enabled-by-addon-title-in-cart addon-field-grid"
                                         style="<?php echo '1' === $addon->get_setting('title_in_cart', 'yes', false) ? 'display: none;' : '' ?> margin-top: 20px;">
                                ...
                                <?php
                                do_action('yith_wapo_addon_editor_after_title_in_cart', $addon);
                                ?>
                                    ...
                                    <div class="field-wrap addon-field-grid">
                                        ...
                                        <div class="field">
                                            <textarea type="text" name="addon_description"
                                                      id="addon-description"><?php echo esc_attr($addon->get_setting('description', '', false)); ?></textarea>
                                        </div>
                                    ...
                                    <div class="field-wrap addon-field-grid">
                                        <label for="addon-id" style="width: 50px;">
                                            <?php
                                            // Translations: Add-on editor panel.
                                            echo esc_html__('ID', 'yith-woocommerce-product-add-ons') . esc_html(':');
                                            ?>
                                        </label>
                                        <div class="field">
                                            <input type="text" name="addon_identificador" id="addon_identificador"
                                                   value="<?php echo esc_attr($addon->get_setting('addon_identificador', '', false)); ?>">
                                        </div>
                                        <span class="description"><?php
                                            // Translations: Add-on editor panel.
                                            echo esc_html__('Introduce un identificador del campo.', 'yith-woocommerce-product-add-ons');
                                            ?>
                                        </span>
                                    </div>
                                    ...
                                    <div id="addon_options">
                                        ...
                                        for ($x = 0; $x < $options_total; $x++) :
                                            ...
                                            <div class="option <?php echo 1 === $options_total ? 'open' : ''; ?>"
                                                 data-index="<?php echo esc_attr($x); ?>">
                                                <div class="actions"
                                                     style="<?php echo 1 === $options_total ? 'display: none;' : ''; ?>">
                                                    <?php
                                                    $actions = array(
                                                        ...
                                                        <div class="additional-options">
                                                            <div class="selected-by-default">
                                                                <?php if (in_array($addon_type, array('checkbox', 'color', 'label', 'product', 'radio', 'select'), true)) : ?>
                                                                    ...
                                                                    <label for="option-default-<?php echo esc_attr($x); ?>"
                                                                           class="selected-by-default-chbx"><?php echo esc_html_x('Selected by default', 'Add-on editor panel', 'yith-woocommerce-product-add-ons'); ?></label>
                                                                    <!-- End option field -->
                                                                <?php endif; ?>
                                                            </div>
                                                            <div class="enabled">
                                    ...
                                    <script type="text/html" id="tmpl-new-option-<?php echo esc_attr($x); ?>">
                                        <div class="option open" data-index="<?php echo esc_attr($x); ?>">
                                            ...
                                            <div class="title">
                                                ...
                                                <div class="addon-name">
                                                    <div class="name">
                                                        <?php echo esc_html(mb_strtoupper($addon_name)); ?> - <span
                                                                class="addon-label-text"></span>
                                                    </div>
                                                    <div class="additional-options">
                                                        <div class="selected-by-default">
                                                            <?php if (in_array($addon_type, array('checkbox', 'color', 'label', 'product', 'radio', 'select'), true)) : ?>
                                                                ...
                                                                <label for="option-default-<?php echo esc_attr($x); ?>"
                                                                       class="selected-by-default-chbx">
                                                                    <?php
                                                                    //translators: Add-on editor panel.
                    ...
                    <input type="hidden" name="block_name"
                           value="<?php echo !empty($block->get_name()) ? $block->get_name() : ($_REQUEST['block_name'] ?? ''); ?>">
                    <input type="hidden" name="block_priority"
                           value="<?php echo !empty($block->get_priority()) ? $block->get_priority() : ($_REQUEST['block_priority'] ?? ''); ?>">
                    <input type="hidden" name="block_rule_show_in"
                           value="<?php echo !empty($block->get_rule('show_in', '')) ? $block->get_rule('show_in') : ($_REQUEST['block_rule_show_in'] ?? ''); ?>">
                    <input type="hidden" name="block_rule_show_in_products"
                           value="<?php echo !empty($block->get_rule('show_in_products', '')) ? esc_attr(json_encode($block->get_rule('show_in_products'))) : (isset($_REQUEST['block_rule_show_in_products']) ? esc_attr(json_encode($_REQUEST['block_rule_show_in_products'])) : ''); ?>">
                    <input type="hidden" name="block_rule_show_in_categories"
                           value="<?php echo !empty($block->get_rule('show_in_categories', '')) ? esc_attr(json_encode($block->get_rule('show_in_categories'))) : (isset($_REQUEST['block_rule_show_in_categories']) ? esc_attr(json_encode($_REQUEST['block_rule_show_in_categories'])) : ''); ?>">
                    <input type="hidden" name="block_rule_exclude_products"
                           value="<?php echo !empty($block->get_rule('exclude_products', '')) ? $block->get_rule('exclude_products') : ($_REQUEST['block_rule_exclude_products'] ?? ''); ?>">
                    <input type="hidden" name="block_rule_exclude_products_products"
                           value="<?php echo !empty($block->get_rule('exclude_products_products', '')) ? esc_attr(json_encode($block->get_rule('exclude_products_products'))) : (isset($_REQUEST['block_rule_exclude_products_products']) ? esc_attr(json_encode($_REQUEST['block_rule_exclude_products_products'])) : ''); ?>">
                    <input type="hidden" name="block_rule_exclude_products_categories"
                           value="<?php echo !empty($block->get_rule('exclude_products_categories', '')) ? esc_attr(json_encode($block->get_rule('exclude_products_categories'))) : (isset($_REQUEST['block_rule_exclude_products_categories']) ? esc_attr(json_encode($_REQUEST['block_rule_exclude_products_categories'])) : ''); ?>">
                    <input type="hidden" name="block_rule_show_to"
                           value="<?php echo !empty($block->get_rule('show_to', '')) ? $block->get_rule('show_to') : (isset($_REQUEST['block_rule_show_to']) && !empty($_REQUEST['block_rule_show_to']) ? $_REQUEST['block_rule_show_to'] : 'all'); ?>">
                    <input type="hidden" name="block_rule_show_to_user_roles"
                           value="<?php echo !empty($block->get_rule('show_to_user_roles', '')) ? esc_attr(json_encode($block->get_rule('show_to_user_roles'))) : (isset($_REQUEST['block_rule_show_to_user_roles']) ? esc_attr(json_encode($_REQUEST['block_rule_show_to_user_roles'])) : ''); ?>">
                ...
                <div id="types">
                    ...
                    <div class="types">
                        <?php foreach (YITH_WAPO()->get_html_types() as $key => $html_type) : ?>
                            ...
                            <a class="type" href="<?php echo esc_attr($html_url); ?>">
                                <div class="icon <?php echo esc_attr($html_type['slug']); ?>"><span
                                            class="wapo-icon wapo-icon-<?php echo esc_attr($html_type['slug']); ?>"></span>
                                </div>
                    ...
                    <div class="types">
                        ...
                        foreach ($addons_type as $key => $addon_type) :
                            ...
                            ?>
                            <a class="type <?php echo esc_attr($class); ?>"
                               href="<?php echo esc_attr($url); ?>" <?php echo 'disabled' === $class ? 'onclick="return false;"' : ''; ?>>
                                <img src="<?php echo esc_attr(YITH_WAPO_URL) . 'assets/img/addons-icons/premium.svg'; ?>"
                                     class="premium-badge">
                                <div class="icon <?php echo esc_attr($addon_type['slug']); ?>"><span
                                            class="wapo-icon wapo-icon-<?php echo esc_attr($addon_type['slug']); ?>"></span>
                                </div>
