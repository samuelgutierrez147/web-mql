...
$option_label = wp_kses_post($addon->get_option('label', $x));
...
<?php else: ?>
    <div id="yith-wapo-option-<?php echo esc_attr($addon->id); ?>-<?php echo esc_attr($x); ?>" class="yith-wapo-option">
        ...
        <?php if ($addon->get_option('characters_limit', $x) === 'yes') : ?>
            ...
            ?>
            <small class="length-error-message"
                   style="color: #f00; padding: 5px 0px; display: none;"><?php echo esc_html($length_error_message); ?></small>
        <?php endif; ?>
