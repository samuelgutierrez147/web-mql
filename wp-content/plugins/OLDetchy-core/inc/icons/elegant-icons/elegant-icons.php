...
if ( ! function_exists( 'etchy_core_add_elegant_icons_to_collection' ) ) {
	function etchy_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'EtchyCoreElegantIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'etchy_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EtchyCoreElegantIconsPack extends QodeFrameworkIconPack {
