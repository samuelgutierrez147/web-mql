...
if ( ! function_exists( 'etchy_core_add_material_icons_to_collection' ) ) {
	function etchy_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'EtchyCoreMaterialIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'etchy_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EtchyCoreMaterialIconsPack extends QodeFrameworkIconPack {
