...
if ( ! function_exists( 'etchy_core_add_font_awesome_to_collection' ) ) {
	function etchy_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'EtchyCoreFontAwesomePack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'etchy_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EtchyCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return ETCHY_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			...
			if ( file_exists( ETCHY_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( ETCHY_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
