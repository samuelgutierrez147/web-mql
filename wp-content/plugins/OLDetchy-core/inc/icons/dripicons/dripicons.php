...
if ( ! function_exists( 'etchy_core_add_dripicons_to_collection' ) ) {
	function etchy_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'EtchyCoreDripiconsIconPack';
		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'etchy_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EtchyCoreDripiconsIconPack extends QodeFrameworkIconPack {
