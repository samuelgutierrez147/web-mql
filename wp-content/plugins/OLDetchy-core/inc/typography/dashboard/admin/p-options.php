...
if ( ! function_exists( 'etchy_core_add_p_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function etchy_core_add_p_typography_options( $page ) {
		...
		if( $page ) {
			$paragraph_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-paragraph',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Paragraph Typography', 'etchy-core' ),
					'description' => esc_html__( 'Set values for paragraph', 'etchy-core' )
				)
			);
	...
	add_action( 'etchy_core_action_after_typography_options_map', 'etchy_core_add_p_typography_options' );
}