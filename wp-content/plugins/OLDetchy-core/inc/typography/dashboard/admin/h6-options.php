...
if ( ! function_exists( 'etchy_core_add_h6_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function etchy_core_add_h6_typography_options( $page ) {
		...
		if ( $page ) {
			$h6_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h6',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H6 Typography', 'etchy-core' ),
					'description' => esc_html__( 'Set values for Heading 6 HTML element', 'etchy-core' )
				)
			);
			...
			$h6_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'General Typography', 'etchy-core' )
				)
			);
			...
			$h6_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Top', 'etchy-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
			...
			$h6_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Bottom', 'etchy-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
			...
			$h6_1024_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1024 Typography', 'etchy-core' )
				)
			);
			...
			$h6_768_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 768 Typography', 'etchy-core' )
				)
			);
			...
			$h6_680_typography_section = $h6_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 680 Typography', 'etchy-core' )
				)
			);
	...
	add_action( 'etchy_core_action_after_typography_options_map', 'etchy_core_add_h6_typography_options' );
}