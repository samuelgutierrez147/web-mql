...
do_action( 'etchy_core_action_before_portfolio_content_holder' );
?>
<main id="qodef-page-content" class="qodef-grid qodef-layout--template <?php echo esc_attr( etchy_core_get_grid_gutter_classes() ); ?>">
	<div class="qodef-grid-inner clear">
		...
		etchy_core_template_part( 'post-types/portfolio', 'templates/portfolio', $content );
...
do_action( 'etchy_core_action_after_portfolio_content_holder' );
?>