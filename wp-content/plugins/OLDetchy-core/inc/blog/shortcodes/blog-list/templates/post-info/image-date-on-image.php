...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php echo etchy_core_get_list_shortcode_item_image( $image_dimension, $blog_list_image, $custom_image_width, $custom_image_height ); ?>
		</a>
		<?php etchy_template_part( 'blog', 'templates/parts/post-info/date' ); ?>
	</div>
<?php } ?>