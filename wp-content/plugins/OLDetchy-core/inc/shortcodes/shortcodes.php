...
if ( ! class_exists( 'EtchyCoreShortcodes' ) ) {
	class EtchyCoreShortcodes {
		...
		function init() {
			...
			include_once ETCHY_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once ETCHY_CORE_SHORTCODES_PATH . '/shortcode.php';
			include_once ETCHY_CORE_SHORTCODES_PATH . '/list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'etchy_core_filter_register_shortcodes', $shortcodes = array() );
	...
	EtchyCoreShortcodes::get_instance();
}