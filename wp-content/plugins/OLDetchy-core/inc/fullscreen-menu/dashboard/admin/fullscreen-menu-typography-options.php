...
if ( ! function_exists( 'etchy_core_fullscreen_menu_typography_options' ) ) {
	function etchy_core_fullscreen_menu_typography_options( $page ) {
		...
		if ( $page ) {
			...
			$typography_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Fullscreen Menu Typography', 'etchy-core' )
				)
			);
	...
	add_action( 'etchy_core_action_after_fullscreen_menu_options_map', 'etchy_core_fullscreen_menu_typography_options', 15 );
}