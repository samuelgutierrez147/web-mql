			...
			<div class="qodef-m-item qodef-e">
				...
				<div class="qodef-e-content">
					...
					<p class="qodef-e-price">
						...
						<span class="qodef-e-quantity"><?php echo sprintf( esc_html__( 'x %s', 'etchy-core' ), esc_attr( $cart_item['quantity'] ) ); ?></span>
					</p>
					<?php echo sprintf( '<a href="%s" class="qodef-e-remove remove" title="%s">%s</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_attr__( 'Remove this item', 'etchy-core' ), qode_framework_icons()->get_specific_icon_from_pack( 'close', 'elegant-icons' ) ); ?>
				</div>
			</div>
		<?php }
	} ?>
