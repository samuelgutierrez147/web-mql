<div <?php wc_product_class( $item_classes ); ?>>
    <div class="qodef-woo-product-inner">
            ...
            <div class="qodef-woo-product-image">
                ...
                <div class="qodef-woo-product-image-inner">
	                <div class="qodef-woo-product-image-inner-2">
						...
						<?php
							etchy_core_template_part( 'plugins/woocommerce/shortcodes/product-list', 'templates/post-info/add-to-cart' );?>
		                </div>
		                <?php // Hook to include additional content inside product list item image
        ...
        <div class="qodef-woo-product-content">
			...
			do_action( 'etchy_core_action_product_list_item_additional_content' );
			?>
        </div>
