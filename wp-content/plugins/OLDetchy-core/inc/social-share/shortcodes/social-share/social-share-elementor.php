...
class EtchyCoreElementorSocialShare extends \Elementor\Widget_Base{
	...
	public function set_object(){
		$this->object = qode_framework_get_framework_root()->get_shortcodes()->get_shortcode('etchy_core_social_share');
	}
...
etchy_core_get_elementor_widgets_manager()->register_widget_type( new EtchyCoreElementorSocialShare() );